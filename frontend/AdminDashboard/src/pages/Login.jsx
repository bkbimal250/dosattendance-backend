...
import AuthHeader from '@/components/AuthFiles/AuthHeader';
import AuthFooter from '@/components/AuthFiles/AuthFooter';
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full flex items-center justify-center">
              ...
              />
              <div className="hidden text-white font-bold text-xl">DOS</div>
            </div>
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Disha Online Solution</h1>
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-gray-500">© 2024 Disha Online Solution. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
